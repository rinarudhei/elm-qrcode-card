...
var $author$project$Main$fontOutfit = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$typeface('Outfit')
		]));
...
var $author$project$Main$slate500 = A3($escherlies$elm_color$Color$hsl, 216, 0.15, 0.48);
...
var $author$project$Main$toElementColor = function (color) {
	return $mdgriffith$elm_ui$Element$fromRgb(
		$escherlies$elm_color$Color$toRgba(color));
};
var $author$project$Main$slate500Element = $author$project$Main$toElementColor($author$project$Main$slate500);
var $author$project$Main$slate900 = A3($escherlies$elm_color$Color$hsl, 218, 0.44, 0.22);
var $author$project$Main$slate900Element = $author$project$Main$toElementColor($author$project$Main$slate900);
...
var $author$project$Main$cardDescription = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$color($author$project$Main$slate900Element),
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('Improve your front-end skills by building projects')
				])),
			A2(
			$mdgriffith$elm_ui$Element$paragraph,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$color($author$project$Main$slate500Element),
					$mdgriffith$elm_ui$Element$Font$center,
					$mdgriffith$elm_ui$Element$Font$size(15),
					$mdgriffith$elm_ui$Element$height(
					$mdgriffith$elm_ui$Element$px(63)),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$style, 'line-height', '1.4'))
				]),
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('Scan the QR code to visit Frontend Mentor and take your coding skills to the next level')
				]))
		]));
...
var $author$project$Main$qrCodeImage = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width(
			$mdgriffith$elm_ui$Element$px(288)),
			$mdgriffith$elm_ui$Element$height(
			$mdgriffith$elm_ui$Element$px(288)),
	...
	A2(
		...
		{description: 'qr code', src: './static/image-qr-code.png'}));
...
var $author$project$Main$qrCard = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$paddingEach(
			{bottom: 40, left: 16, right: 16, top: 16}),
			...
			{
				blur: 25,
				color: A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 0.0477),
				offset: _Utils_Tuple2(0, 25),
				size: 0
			})
		]),
	_List_fromArray(
		[$author$project$Main$qrCodeImage, $author$project$Main$cardDescription]));
var $author$project$Main$slate300 = A3($escherlies$elm_color$Color$hsl, 212, 0.45, 0.89);
var $author$project$Main$slate300Element = $author$project$Main$toElementColor($author$project$Main$slate300);
var $author$project$Main$main = A2(
	$mdgriffith$elm_ui$Element$layout,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Background$color($author$project$Main$slate300Element),
			$author$project$Main$fontOutfit
		]),
	$author$project$Main$qrCard);
